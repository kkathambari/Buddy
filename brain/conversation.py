...
def stream_process_chat(user_input, stats, energy, companion_id: str = "default_pet", user_uid: str = None, image_data: str = None):
    from brain.tone import analyze_tone
    from brain.reflection import SelfReflection
    
    if image_data:
        user_input += "\n[SYSTEM: The user attached an image with this message. If your AI provider supports vision, analyze it. Otherwise, acknowledge the image.]"
