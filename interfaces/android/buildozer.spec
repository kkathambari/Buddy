...
# (str) Package name
package.name = devbuddy

# (str) Package domain (needed for android/ios packaging)
package.domain = com.kkath
...
requirements = python3,kivy,openai,anthropic,google-generativeai,requests,plyer,pyjnius
...
#       [app]
#       title = DevBuddy # This is not a comment, it is part of the title.
#
#   Warning: Indented text is treated as a multiline string - i.e.
#       [app]
#       title = DevBuddy
#          package.name = devbuddy # This is all part of the title.
#
